      ...
      <div className="p-8 max-w-[1100px] mx-auto ">
        <div className="flex flex-col md:flex-row items-start gap-16 ">
          ...
          <div className="flex flex-col gap-4 w-full md:w-fit ">
            <a href="https://discord.com" target="_blank" className="bg-green-500 p-4 text-[0.875rem] flex items-center rounded uppercase gap-2 justify-center hover:bg-green-700 transition-colors">
              <DiscordLogo size={24}/>
